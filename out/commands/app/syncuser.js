            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        for (x = 0; x <= users_arr.length - 1; x++) {
                            o = users_arr[x];
                            console_1.default.log(o);
                            user = o;
                            if (String(user.discordID) === String(userId)) {
                                console_1.default.log("FOUND THE CORRECT USER");
                                e = (0, embedcreator_1.Emb_Useralreadysynced)(user.fivemLicenseID, user.discordID, user.discordName, user.currsocketID, user.currpostal);
                                (0, System_1.Send_Embeded)(e, channelID);
                                isfound = true;
                            }
                        }
